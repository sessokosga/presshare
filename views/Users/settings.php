...
switch($action):
  case 'main': ?>
  <ul class="settings">
    <li><h4><a href="<?=ROOT_URL?>settings/profile">Profile</a></h4>
    <li><h4><a href="<?=ROOT_URL?>settings/email">Update email</a></h4>
    <li><h4><a href="<?=ROOT_URL?>settings/password">Change password </a></h4>
  </ul>
