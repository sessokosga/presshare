...
<div id="add-press" class="add-press">
	<h2>Ajouter un Press <button class="button" id="btn-close-form-press"> <img class="svg"  src="'.ROOT_URL.'svg/times-circle.svg" alt="Fermer"> Fermer</button></h2>
	<form method="post" class="form-press" action="'.ROOT_URL.'press/add">
		<div class="form-press-left">
			<label for="p.title">Titre :</label> <input minlength="1" maxlength="25" required type="text" id="p.title" name="p.title" placeholder="Entrer un titre"><br>
